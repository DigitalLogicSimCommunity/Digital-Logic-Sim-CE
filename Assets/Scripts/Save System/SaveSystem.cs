...
public static class SaveSystem {
    ...
    public static Dictionary<string, List<int>> LoadHDDContents () {
        string hddSaveFile = Path.Combine(CurrentSaveProfileDirectoryPath, "HDDContents.json");
    ...
    public static Dictionary<string, int> LoadCustomFolders () {
        string customFoldersFile = Path.Combine(CurrentSaveProfileDirectoryPath, "CustomFolders.json");
