...
public class EditChipMenu : MonoBehaviour {
    ...
    public bool IsValidChipName(string chipName) {
        ...
        return !Manager.instance.AllChipNames(builtin: true, custom: false).Contains(chipName) && chipName.Length > 0;
    }

	public void SubmitDeleteChip() {
		UIManager.NewSubmitMenu(
			header: "Delete Chip", 
    ...
    public void ExportChip() {
        ImportExport.instance.ExportChip(currentChip);
    }
