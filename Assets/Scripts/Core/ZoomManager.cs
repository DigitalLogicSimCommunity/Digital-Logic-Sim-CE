...
public class ZoomManager : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        targetCamPosition =
            new Vector3(Mathf.Clamp(targetCamPosition.x, -zoomMoveRange.x * zoom,
                                    zoomMoveRange.x * zoom),
                        Mathf.Clamp(targetCamPosition.y, -zoomMoveRange.y * zoom,
                                    zoomMoveRange.y * zoom),
                        0);
        transform.position = Vector3.Lerp(transform.position, targetCamPosition,
